...
INSERT INTO `OZONE_DB`.`GasTypes` (`idgasType`, `gasName`) VALUES (0, 'CO2');
...
INSERT INTO `OZONE_DB`.`UserTypes` (`idUserType`, `userTypeName`) VALUES (0, 'user');
